...
A token account holds the balance of a specific spl-token for a specific user. To understand the difference between this and an ATA, read [this section](/docs/testing-with-spl-tokens#types-of-token-accounts).
