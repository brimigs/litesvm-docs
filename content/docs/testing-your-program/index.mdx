...
3. Add any additional dev dependencies that may be needed, like `solana-sdk` and `litesvm-token`
4. Create a test file in your `tests` directory - `src` and `tests` should be at the same level in your directory structure.
