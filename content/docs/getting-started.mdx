...
Add the LiteSVM Go bindings and `solana-go` (used for keypairs, instructions, and transaction building) to your module:
...
Initialize a Go module and create a test file:
...
func TestTransfer(t *testing.T) {
    ...
    // Create two accounts
    alicePriv, _ := solana.NewRandomPrivateKey()
    ...
    // Check new balances
    bobBal, _, _ := svm.Balance(bob)
    aliceBal, _, _ := svm.Balance(alice)
