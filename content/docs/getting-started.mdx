...
<Callout type="warning"> Dependency Versions: LiteSVM depends on several Solana crates. If your project uses different versions, you may run into type mismatches or build errors. To verify the versions in use, run:

```bash
cargo tree -p litesvm
```
...
- **[Concept Examples →](/docs/examples)** - Copy-paste solutions for common scenarios
- **[Complete Examples →](/docs/complete-examples)** - Jump straight into full application examples
