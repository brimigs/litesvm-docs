...
This example shows how to deploy a program to LiteSVM and call it with an instruction.
...
3. **Program ID**: Generate a unique ID or use the keypair from `target/deploy/`
