...
This covers the simplest transaction type. For testing with custom programs, see [Program Testing](/docs/typescript/examples/program-testing). For token transfers (mints, ATAs), see [Token Testing](/docs/typescript/tokens).
